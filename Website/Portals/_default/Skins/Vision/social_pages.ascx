...
<StyleWizard:Skin runat="server" id="VisionStyleWizard" templateGroup="socialPages" />
	...
	<div class="EDS_content-background">
		...
		<div class="EDS_content-bg">
			...
			<div class="EDS_content">
				<div class="EDS_contentAbove" runat="server" id="ContentAbove"></div>
				<div id="RightPane" runat="server" class="EDS_three-column-social-right"></div>
				<div id="LeftPane" runat="server" class="EDS_three-column-social-left"></div>
				<div id="ContentPane" runat="server" class="EDS_three-column-social-center"></div>
				<div class="EDS_clear"></div>
