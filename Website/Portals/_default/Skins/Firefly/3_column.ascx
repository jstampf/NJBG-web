...
<div class="EasyDNNSkin_Firefly" id="top">
	...
	<div class="EDS_content-bg">
		...
		<div class="EDS_content EDS_no-background">
			...
			<div class="EDS_three-column-sidebar-left" runat="server" id="SidebarLeft"></div>
			<div class="EDS_three-column-content" runat="server" id="ContentPane"></div>
			<div class="EDS_three-column-sidebar-right" runat="server" id="SidebarRight"></div>
			<div class="EDS_clear"></div>
