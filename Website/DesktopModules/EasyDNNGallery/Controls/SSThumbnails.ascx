...
<script src="<%=ModulePath.Replace("Controls/","")%>js/jquery.timers-1.1.2_1.10.js" type="text/javascript"></script>
...
<asp:ObjectDataSource ID="odsGetOnlyImages" runat="server" TypeName="EasyDNN.Modules.EasyDNNGallery.DataAcess" SelectMethod="GetOnlyImagesFromGallery">
    <SelectParameters>
