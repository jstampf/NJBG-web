									...
									<div class="EDGcornertopright">
										<div class="EDGcontent">
											...
											<asp:Panel ID="pnlTGDisplay" runat="server" HorizontalAlign="Center">
												...
												<%=SetupSSValues()%>
												<asp:GridView ID="gvTGPagination" runat="server" AllowPaging="True" DataKeyNames="PictureID" OnPageIndexChanged="GridView1_PageIndexChanged" OnPreRender="gvTGPagination_PreRender"
