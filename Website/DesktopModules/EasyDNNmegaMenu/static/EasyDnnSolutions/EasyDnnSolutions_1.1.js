			...
			api: {
				...
				load: function () {
					var tagId = 'eds_googleMapsApi',
						...
						script,
						src = 'https://maps.googleapis.com/maps/api/js?v=3.24&callback=' + self.parent.options.instanceGlobal + '.google.maps.api.callback';
...
if (initOptions && initOptions.instanceGlobal && window[initOptions.instanceGlobal] == undefined)
